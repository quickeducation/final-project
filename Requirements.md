...
- The 10 scores displayed on the finished problem set page must be accurate to the database when the webpage has finished loading within 5 seconds on UW wifi. (Complete)
